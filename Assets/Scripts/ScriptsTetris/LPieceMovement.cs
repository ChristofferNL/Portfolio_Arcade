...
public class LPieceMovement : Piece
{
    ...
    {
        if (!colliders[1].IsCollidingWithMesh && !colliders[2].IsCollidingWithMesh && !colliders[3].IsCollidingWithMesh)
        {
            canRotateRight = true;
        }
        else
    ...
    public override void MovementCheckerLeft()
    {
        ...
        if (rotationState == 0 && !movementColliders[6].IsCollidingWithMesh && !movementColliders[1].IsCollidingWithMesh)
        {
            canMoveLeft = true;
            return;
        }
    ...
    {
        if (rotationState == 0 && !movementColliders[2].IsCollidingWithMesh && !movementColliders[3].IsCollidingWithMesh && !movementColliders[5].IsCollidingWithMesh)
        {
            canMoveDown = true;
            return;
        }
